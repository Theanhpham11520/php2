                    ...
                    <div class="col-12">
                        ...
                        <form action="/checkout_product" method="post">
                            <div class="checkout-cart-total" style="padding-bottom: 100px;">
                                ...
                                <ul>
                                    ...
                                    if (isset($_SESSION['cart'])):
                                        foreach ($_SESSION['cart'] as $key => $gid):
                                            ...
                                            <li><?= $getcart->name; ?> <span><?= number_format($tongtien); ?> VNĐ</span></li>
                                        <?php
                                        endforeach;
                                    endif;
                                    ?>
                                ...
                                <input type="hidden" name="total_price" value="<?= $tongtien+$ship ?>">
                                ...
                                <h4>Tổng số tiền phải thanh toán
                                    <span><?= number_format($tongtien+$ship) ?> VNĐ</span>
                                </h4>
