                                                    ...
                                                    foreach ($_SESSION['cart'] as $item) :
                                                        ...
                                                        <div class="single-cart-item">
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <p class="count"><span>1 x </span> <?= number_format($getpr->price); ?> VNĐ</p>
                                                            </div>
                                                        </div>
                                                    <?php endforeach;
                                                }else{
                                        ...
                                        <div class="cart-calculation">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?= number_format($tongtien) ?> VNĐ</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?= number_format($tongtien + $ship) ?> VNĐ</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
